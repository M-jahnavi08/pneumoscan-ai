...
.result-pneumonia {
    background: linear-gradient(135deg, rgba(255,68,102,0.08), rgba(255,68,102,0.03));
...
.result-normal .result-label  { color: rgba(0,255,136,0.6); }
.result-normal .result-value  { color: var(--accent-green); text-shadow: var(--glow-green); }
.result-pneumonia .result-label { color: rgba(255,68,102,0.6); }
.result-pneumonia .result-value { color: var(--accent-red); text-shadow: var(--glow-red); }
...
.conf-pct-green { color: var(--accent-green); }
.conf-pct-red   { color: var(--accent-red); }
...
<div class="stats-bar">
    ...
    <div class="stat-item">
        <span class="stat-value">5,863</span>
        <div class="stat-label">Training Images</div>
    </div>
    <div class="stat-item">
        <span class="stat-value">EfficientB3</span>
        <div class="stat-label">Architecture</div>
    </div>
    <div class="stat-item">
        <span class="stat-value">Grad-CAM</span>
...
with left:
    # Upload section
    st.markdown("""
    <div class="section-heading">Upload X-Ray</div>
    """, unsafe_allow_html=True)
    ...
    <div style="text-align:center; padding: 0.5rem 0 1rem;">
        <span style="font-family:'Space Mono',monospace; font-size:0.65rem;
                     letter-spacing:0.15em; color:#5a7a9a; text-transform:uppercase;">
    ...
    <div class="info-card">
        ...
        <div style="font-size:0.85rem; color:#c0d8f0; margin-bottom:1rem;">
            EfficientNetB3 fine-tuned with transfer learning on 5,863 labeled chest X-rays
            from the NIH Kaggle dataset.
        </div>
    ...
    <div class="warning-badge">
        ⚠️ For educational & research purposes only. Not a certified medical device.
    ...
    if uploaded is None:
        ...
        ">
            ...
            <div style="font-family:'Space Mono',monospace; font-size:0.8rem;
                        letter-spacing:0.1em; color:#5a7a9a; text-transform:uppercase;
                        margin-bottom:0.5rem;">
                Awaiting X-Ray Input
            </div>
            <div style="font-size:0.82rem; color:#3a5a7a; max-width:280px; line-height:1.6;">
                Upload a chest X-ray on the left to receive an AI diagnosis
                with explainability heatmap
            </div>
            <div style="margin-top:2rem; display:flex; gap:1.5rem;">
                <div style="text-align:center;">
                    <div style="font-family:'Space Mono',monospace; font-size:1.1rem;
                                color:rgba(0,212,255,0.3);">01</div>
                    <div style="font-size:0.7rem; color:#3a5a7a; margin-top:0.2rem;">Upload</div>
                </div>
                <div style="color:#3a5a7a; padding-top:0.3rem;">→</div>
                <div style="text-align:center;">
                    <div style="font-family:'Space Mono',monospace; font-size:1.1rem;
                                color:rgba(0,212,255,0.2);">02</div>
                    <div style="font-size:0.7rem; color:#3a5a7a; margin-top:0.2rem;">Analyse</div>
                </div>
                <div style="color:#3a5a7a; padding-top:0.3rem;">→</div>
                <div style="text-align:center;">
                    <div style="font-family:'Space Mono',monospace; font-size:1.1rem;
                                color:rgba(0,212,255,0.2);">03</div>
                    <div style="font-size:0.7rem; color:#3a5a7a; margin-top:0.2rem;">Explain</div>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        if pred_idx == 0:
            ...
            <div class="result-normal">
                ...
                <div style="font-size:0.8rem; color:rgba(0,255,136,0.5);
                            margin-top:0.4rem;">
            ...
            <div class="result-pneumonia">
                ...
                <div style="font-size:0.8rem; color:rgba(255,68,102,0.5);
                            margin-top:0.4rem;">
                    Pneumonia indicators detected — consult a radiologist
                </div>
            </div>
            """, unsafe_allow_html=True)
        ...
        # ── Confidence bars ────────────────────────────────────────────────
        st.markdown("""
        <div class="section-heading">Confidence Scores</div>
        """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div style="background:#0d1320; border:1px solid rgba(0,212,255,0.1);
                    border-radius:10px; padding:1rem 1.2rem;">
            <div class="conf-row">
                <div class="conf-name">Normal</div>
                <div class="conf-bar-bg">
                    <div class="conf-bar-fill-green" style="width:{n_pct}%"></div>
                </div>
            ...
            <div class="conf-row">
                ...
                <div class="conf-bar-bg">
                    <div class="conf-bar-fill-red" style="width:{p_pct}%"></div>
                </div>
